...
function execute(url) {
    url = url
        .replace(/https?:\/\/(book|huayu)\.zongheng\.com\/book\/(\d+)\.html$/g, 'http://$1.zongheng.com/showchapter/$2.html')
        .replace(/https?:\/\/m\.zongheng\.com\/h.+\/book\?bookid=(\d+).+$/, 'http://book.zongheng.com/showchapter/$1.html');
